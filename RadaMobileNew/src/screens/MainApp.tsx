...
import LearningBuddiesScreen from './LearningBuddiesScreen';
import NotificationSettingsScreen from './NotificationSettingsScreen';
import NotificationCenterScreen from './NotificationCenterScreen';
import ContentManagementScreen from './ContentManagementScreen';
import ContentEditorScreen from './ContentEditorScreen';
import AnalyticsDashboardScreen from './AnalyticsDashboardScreen';
import UserInsightsScreen from './UserInsightsScreen';
...
const LearningStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="Quiz" component={QuizScreen} />
            ...
            <Stack.Screen name="LearningBuddies" component={LearningBuddiesScreen} />
            ...
            <Stack.Screen name="UserInsights" component={UserInsightsScreen} />
  </Stack.Navigator>
);
...
const MainApp = () => {
  ...
  const isAdmin = (user as any)?.role === 'admin' || (user as any)?.role === 'moderator' || (user as any)?.role === 'educator';
  if (isAdmin) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {showAdminDashboard && (
        ...
        >
          <EnhancedAdminDashboard onClose={() => setShowAdminDashboard(false)} />
        </Modal>
      )}
